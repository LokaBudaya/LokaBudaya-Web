...
function HomePage({ events }) {
    ...
    useEffect(() => {
        ...
        const unsubscribeKuliners = onSnapshot(collection(db, 'kuliners'), (snapshot) => {
    ...
    return (
        <div>
            ...
            <CategorySection events={events} tours={tours} kuliners={kuliners} />
            <DestinationCarousel />
...
function CategorySection({ events, tours, kuliners }) {
